...
features = readmatrix('extracted_features_with_prefixes_vgg19_test.xlsx');  % Replace with your file path

% Number of features
num_features = size(features, 1);  % Number of columns in the feature matrix

% Define feature groups to display
groups_to_display = [3, 10, 60, 120, 180, num_features];  
...
for i = 1:length(groups_to_display)
    ...
    plot(features(1:num_to_display,2:30)');
