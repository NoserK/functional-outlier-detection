...
for(i in 1:16)
{
  ...
  #test
  Embedded_SqueezeNet_Tain_Images <- read_excel("Embedded_SqueezeNet_Tain_Images.xlsx")
  Embedded_SqueezeNet_Test_Images <- read_excel("Embedded_SqueezeNet_Test_Images.xlsx")
  
  data_Test1=subset(Embedded_SqueezeNet_Test_Images,category=="Test001")
  data_Test2=subset(Embedded_SqueezeNet_Test_Images,category=="Test002")
  data_Test3=subset(Embedded_SqueezeNet_Test_Images,category=="Test003")
  data_Test4=subset(Embedded_SqueezeNet_Test_Images,category=="Test004")
  data_Test5=subset(Embedded_SqueezeNet_Test_Images,category=="Test005")
  data_Test6=subset(Embedded_SqueezeNet_Test_Images,category=="Test006")
  data_Test7=subset(Embedded_SqueezeNet_Test_Images,category=="Test007")
  data_Test8=subset(Embedded_SqueezeNet_Test_Images,category=="Test008")
  data_Test9=subset(Embedded_SqueezeNet_Test_Images,category=="Test009")
  data_Test10=subset(Embedded_SqueezeNet_Test_Images,category=="Test010")
  data_Test11=subset(Embedded_SqueezeNet_Test_Images,category=="Test011")
  data_Test12=subset(Embedded_SqueezeNet_Test_Images,category=="Test012")
  ...
  data_train1=subset(Embedded_SqueezeNet_Tain_Images,category=="Train001")
  data_train2=subset(Embedded_SqueezeNet_Tain_Images,category=="Train002")
  data_train3=subset(Embedded_SqueezeNet_Tain_Images,category=="Train003")
  data_train4=subset(Embedded_SqueezeNet_Tain_Images,category=="Train004")
  data_train5=subset(Embedded_SqueezeNet_Tain_Images,category=="Train005")
  data_train6=subset(Embedded_SqueezeNet_Tain_Images,category=="Train006")
  data_train7=subset(Embedded_SqueezeNet_Tain_Images,category=="Train007")
  data_train8=subset(Embedded_SqueezeNet_Tain_Images,category=="Train008")
  data_train9=subset(Embedded_SqueezeNet_Tain_Images,category=="Train009")
  data_train10=subset(Embedded_SqueezeNet_Tain_Images,category=="Train010")
  data_train11=subset(Embedded_SqueezeNet_Tain_Images,category=="Train011")
  data_train12=subset(Embedded_SqueezeNet_Tain_Images,category=="Train012")
  data_train13=subset(Embedded_SqueezeNet_Tain_Images,category=="Train013")
  data_train14=subset(Embedded_SqueezeNet_Tain_Images,category=="Train014")
  data_train15=subset(Embedded_SqueezeNet_Tain_Images,category=="Train015")
  data_train16=subset(Embedded_SqueezeNet_Tain_Images,category=="Train016")
  ...
  y=matrix(0,nrow = k+1,ncol = 1000)
  
  y[1:k,]=as.matrix(get(paste0("data_train",i)))-rep(1,k)%*%t(matrix(get(paste0("mtrain",i))))+matrix(0.0001*rnorm(k*1000),nrow = k,ncol = 1000)
  
  all_results <- foreach(test_ind = 1:12) %dopar% {
    n <- dim(get(paste0("data_Test", test_ind)))[1]
    resultd <- as.vector(rep(0, n))
    resultf <- as.vector(rep(0, n))
    
    for (m in 1:n) {
      y[k + 1, ] <- as.matrix(get(paste0("data_Test", test_ind))[m, ]) - 
        get(paste0("mTest", test_ind)) + 0.0001 * rnorm(1000, 0, 1)
      
      temp1 <- fbplot(t(y), factor = 1.5, plot = FALSE)
      resultf[m] <- temp1$depth[k + 1]
      
      temp2 <- detectOutlier(t(y), nCurve = k + 1, nPoint = 1000, 1.5)
      resultd[m] <- temp2$TVD[k + 1]
    }
  ...
  write.table(df, file = "output1.csv", append = TRUE, col.names = !file.exists("output1.csv"), 
              row.names = FALSE)
