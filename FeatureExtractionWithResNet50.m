...
layer = 'avg_pool';  % or 'fc1000', depending on what works best
...
for k = 1:length(subFolders)
    ...
    for i = 1:length(tifFiles)
        ...
        % Resize the image to the input size of the VGG-16 network
...
filename = 'extracted_features_with_prefixes_ResNet_train.xlsx';
...
% Export the table to an Excel file
filename = 'extracted_features_with_prefixes_ResNet_test.xlsx';
